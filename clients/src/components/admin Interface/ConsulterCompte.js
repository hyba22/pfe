              ...
              if(el.statut==="En attente" || el.statut==="en attente"){
                return ( <>
                  <tr key={el._id}>
                    ...
                    <span className="text-gradient" ><i className='fa fa-check-square'></i></span> </a></td>
            
                    <td> <a onClick={()=>handleOpen(el)} className="btn border-shadowupdate update">
                        <span className="text-gradient"><i className="fas fa-pencil-alt"></i></span> </a></td>
                    <td> <a onClick={()=>handleDelete(el._id)} className="btn border-shadowdelete delete" >
                        <span className="text-gradient"><i className="fas fa-times"></i></span> </a></td>
